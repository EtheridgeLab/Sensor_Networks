...
ThingSpeakPublisher::ThingSpeakPublisher() : dataPublisher() {
    ...
    _thingSpeakUsername   = NULL;  //Zgeneral
    _thingSpeakPassword   = NULL;  //Zgeneral
    _thingSpeakClientID   = NULL;  //Zgeneral
}
...
ThingSpeakPublisher::ThingSpeakPublisher(Logger& baseLogger,
    ...
    setUsername(thingSpeakUsername);  //Zgeneral
    setPassword(thingSpeakPassword);  //Zgeneral
    setClientID(thingSpeakClientID);  //Zgeneral
    // MS_DBG(F("ThingSpeakPublisher object created"));
}
