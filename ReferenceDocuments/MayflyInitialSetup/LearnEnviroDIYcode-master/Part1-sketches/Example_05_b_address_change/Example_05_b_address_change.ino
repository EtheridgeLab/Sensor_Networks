...
Hi there! This is the final tutorial sketch for setting up the Mayfly. This
sketch sets up the address of the Hydros-21 SDI-12 sensor. Z? For this sketch,
make sure that you have plugged the Hydros-21 sensor into one of the SDI-12
ports of the Mayfly.

Once you have uploaded the sketch, type the 1 into the dialogue box when
you are prompted to select an address for the SDI-12 device. 
